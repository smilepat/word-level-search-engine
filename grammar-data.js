...
(function (root, factory) {
  ...
  const raw = [
    ...
    { id: 'GR-2015-002', ex: 'The store is closed.', ko: '상태 수동 (be + p.p.)', en: 'stative passive', intro: '중1-3', explicit: '중1-3', kw: ['수동', 'be p.p.', 'closed', '상태'], note: '동작의 수동태(was written by ~)와 달리 상태·결과를 나타냄. 수동태와 함께 중등에서 다룸.' },
    { id: 'GR-2015-015', ex: 'I made him carry the box.', ko: '사역동사 (make/have/let)', en: 'causative verb', intro: '중1-3', explicit: '중1-3', kw: ['사역동사', 'make', 'let', 'have', '원형부정사'], note: '중3 도입·출제. 지각동사(see/hear + 원형·-ing)와 묶어 고1에서 심화.' },
    ...
    { id: 'GR-2015-038', ex: 'It is important to protect our environment.', ko: '가주어 it + to부정사', en: 'anticipatory "it"', intro: '중1-3', explicit: '중1-3', kw: ['가주어', 'it', 'to부정사', '진주어'], note: '가주어-진주어는 중3~고1 경계. to부정사 진주어가 먼저이고, that절 진주어는 고등에서 다룸.' },
    { id: 'GR-2015-022', ex: 'She said, "I will help you."', ko: '직접화법', en: 'direct speech', intro: '중1-3', explicit: '중1-3', kw: ['직접화법', 'said', '인용', '화법'], note: '직접 인용(따옴표)은 중등 수준이나, 간접화법으로의 화법 전환은 고등에서 명시적으로 다룸.' },
